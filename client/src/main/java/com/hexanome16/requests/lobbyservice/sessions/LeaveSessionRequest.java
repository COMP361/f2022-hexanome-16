...
public class LeaveSessionRequest {
    public static void execute(long sessionId, String player, String access_token) {
        HttpClient client = RequestClient.getClient();
        try {
            String url = "http://127.0.0.1:4242/api/sessions/" + sessionId + "/players/" + player + "?access_token=" + access_token;
