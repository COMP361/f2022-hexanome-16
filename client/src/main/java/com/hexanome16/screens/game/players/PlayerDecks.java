package com.hexanome16.screens.game.players;
...
public class PlayerDecks {
    ...
    public static void generateAll(){
        ...
        FXGL.spawn("GreenCard", x_shift + x*scale, y_shift + 120  + y * scale).setScaleUniform(0.25 * scale);
        FXGL.spawn("BlueCard", x_shift, y_shift + 130 + 2 * y * scale).setScaleUniform(0.25 * scale);
        FXGL.spawn("WhiteCard", x_shift + x*scale, y_shift + 130  + 2 * y * scale).setScaleUniform(0.25 * scale);
        FXGL.spawn("BlackCard", x_shift, y_shift + 140  + 3 * y * scale).setScaleUniform(0.25 * scale);
        FXGL.spawn("GoldCard", x_shift+ x*scale, y_shift + 140  + 3 * y * scale).setScaleUniform(0.25 * scale);
        FXGL.spawn("NobleCard", x_shift+ x*scale/2.0, y_shift + 150  + 4 * y * scale).setScaleUniform(0.2 * scale);
        FXGL.spawn("PlayerTokens", x_shift , y_shift + 100).setScaleUniform(1.2 * scale);
        FXGL.spawn("ReservedNobles", x_shift + x*scale + 95 , y_shift + 120 + y * scale).setScaleUniform(0.1 * scale);
        FXGL.spawn("ReservedCards",x_shift + x*scale + 95 , y_shift + 180 + y * scale).setScaleUniform(0.07 * scale);
        FXGL.spawn("ReservedCards",x_shift + x*scale + 95 , y_shift + 240 + y * scale).setScaleUniform(0.07 * scale);
        FXGL.spawn("ReservedCards", x_shift + + x*scale + 95, y_shift + 300 + y * scale).setScaleUniform(0.07 * scale);
        ...
        FXGL.spawn("PlayerTokens",140 +  width / 4 - (2*x + 20)* scale , 1).setScaleUniform(1.2 * scale);
        FXGL.spawn("ReservedNobles",140 +  width / 4 + 10 + (7*x + 10)* scale, 85*scale).setScaleUniform(0.1 * scale);
        FXGL.spawn("ReservedCards", 140 + width / 4 + 10 + (7*x  + 10)* scale, 1).setScaleUniform(0.07 * scale);
        FXGL.spawn("ReservedCards", 140 + width / 4 + 10 + (7*x  + 70)* scale, 1).setScaleUniform(0.07 * scale);
        FXGL.spawn("ReservedCards",140 +  width / 4 + 10 + (7*x + 130)* scale, 1).setScaleUniform(0.07 * scale);
        ...
        FXGL.spawn("WhiteCard", x + x*scale, y_shift + 130  + 2 * y * scale).setScaleUniform(0.25 * scale);
        FXGL.spawn("BlackCard", x, y_shift + 140  + 3 * y * scale).setScaleUniform(0.25 * scale);
        FXGL.spawn("GoldCard", x+ x*scale, y_shift + 140  + 3 * y * scale).setScaleUniform(0.25 * scale);
        FXGL.spawn("NobleCard", x+ x*scale/2.0, y_shift + 150  + 4 * y * scale).setScaleUniform(0.2 * scale);
